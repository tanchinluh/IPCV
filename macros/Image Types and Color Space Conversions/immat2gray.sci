...
////////////////////////////////////////////////////////////
function [G] = immat2gray(M, mm)
    //    Convert matrix to grayscale image
    //
    //    Syntax
    //      G = immat2gray(M)
    //      G = immat2gray(M, [mmin, mmax])
    //
    //    Parameters
    //       M : An matrix/image.
    ...
    //
    //    Description
    //      immat2gray(M,[mmin, mmax]) converts the matrix M to the double precision image. The output matrix contains values in the range [0.0, 1.0]. mmin and mmax are the values in M that correspond to 0.0 and 1.0 in the output image.
    //

...
//=============================================================================
function imout = imdilate(imin,se,iterations,anchor,borderType,borderValue)
    // Image dilation
    //
    // Syntax
    //    imout = imdilate(imin,se)
    //    imout = imdilate(imin,se,iterations)
    //    imout = imdilate(imin,se,iterations,anchor,borderType,borderValue)
    //
    // Parameters
    //    imin : Input image
    //    se : Structure element
    //    iterations : Number of dilation iterations. Default is 1
    ...
    imout = int_imdilate(imin,se,iterations,round(anchor(1)),round(anchor(2)),borderTypeValue,useDefaultBorderValue,borderValue);

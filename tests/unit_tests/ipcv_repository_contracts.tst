//==============================================================================
// IPCV 5.0.0.2 repository metadata contracts
// <-- NO CHECK REF -->
//==============================================================================
...
assert_checkequal(versionText, "5.0.0.2");

description = mgetl(fullfile(root, "DESCRIPTION"));
versionRows = grep(description, "Version: 5.0.0.2");
assert_checkequal(size(versionRows, "*"), 1);

changeLog = mgetl(fullfile(root, "ChangeLog.txt"));
assert_checktrue(size(grep(changeLog, "Version 5.0.0.2"), "*") >= 1);

...
assert_checkequal(imcount(imagePath), 1);
assert_checktrue(imreadable(imagePath));
assert_checkfalse(imreadable(fullpath(TMPDIR + "/ipcv_missing_image.png")));
...
assert_checkequal(imcount(multiPath), multiInfo(4));

...
IPCV_CORE_API int ipcv_detect_harris(const IpcvDecodedImage *source, int max_corners, double quality_level, double min_distance, int block_size, double k, IpcvKeypointMatrix *keypoints);
IPCV_CORE_API int ipcv_detect_kaze(const IpcvDecodedImage *source, IpcvKeypointMatrix *keypoints);
IPCV_CORE_API int ipcv_detect_akaze(const IpcvDecodedImage *source, IpcvKeypointMatrix *keypoints);
...
IPCV_CORE_API int ipcv_compute_kaze_descriptors(const IpcvDecodedImage *source, const IpcvKeypointMatrix *keypoints, IpcvDecodedImage *descriptors);
IPCV_CORE_API int ipcv_compute_akaze_descriptors(const IpcvDecodedImage *source, const IpcvKeypointMatrix *keypoints, IpcvDecodedImage *descriptors);

...
int sci_int_imextract_DescriptorAKAZE(char *fname, void *pvApiCtx)
{
    ...
    ret = ipcv_compute_akaze_descriptors(&image, &keypoints, &descriptors); ipcv_release_image_argument(image);
